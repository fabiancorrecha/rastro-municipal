...
const maquina2 = document.getElementById('maquina-2');

const maquina_2 = (text = '',tiempo = 300, etiqueta = '') => {
  let array2 = text.split('');
  let contador2 = 0;
  etiqueta.innerHTML = '';
  let escribir = setInterval(function() {
    etiqueta.innerHTML += array2[contador2];
    contador2++;
...
maquina_2("Nogales-Veracruzz" , 600, maquina2);